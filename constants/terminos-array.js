export const terminosArray = [
  {
    heading: "Introducción",
    para1:
      " Las presentes condiciones de uso de la página web, regulan los términos de acceso y uso de Al Día, propiedad de ALDIA SAS en    adelante, “la Empresa”, que el usuario del portal deberá aceptar para usar todos los servicios e información que se facilitan desde el portal.",
    para2:
  ...
  {
    heading: "Información y servicios",
    para1:
  ...
  {
    heading: "Responsabilidad del Portal sobre los contenidos",
    para1:
